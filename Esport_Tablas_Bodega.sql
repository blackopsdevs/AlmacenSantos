...
-- -----------------------------------------------------
-- Table `mydb`.`CAT_PERMISO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`CAT_PERMISO` ;

CREATE TABLE IF NOT EXISTS `mydb`.`CAT_PERMISO` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb`.`CAT_ROL_PERMISO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`CAT_ROL_PERMISO` ;

CREATE TABLE IF NOT EXISTS `mydb`.`CAT_ROL_PERMISO` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_CAT_ROL_PERMISO_CAT_PERMISO1`
    ...
    REFERENCES `mydb`.`CAT_PERMISO` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
